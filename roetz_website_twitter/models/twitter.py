...
REQUEST_LIST_URL = '%s/%s/statuses/user_timeline.json' % (API_ENDPOINT, API_VERSION)
URLOPEN_TIMEOUT = 10
...
class TwitterClient(osv.osv):
    ...
    _columns = {
        ...
        'twitter_screen_name': fields.char('Get tweets from this screen name'),
        'twitter_nr_tweets': fields.char('Number of tweets to show on website'),
    }
    ...
    def fetch_favorite_tweets(self, cr, uid, ids, context=None):
        ...
        for website in self.browse(cr, uid, ids, context=context):
            ...
            params['count'] = website.twitter_nr_tweets
            ...
            response = self._request(website, REQUEST_LIST_URL, params=params)
